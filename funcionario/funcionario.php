<body>
    ...
    <div class="modal fade" id="funcionarioAddModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <!-- Editar Funcionario -->
    <div class="modal fade" id="funcionarioEditModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="funcionarioViewModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
